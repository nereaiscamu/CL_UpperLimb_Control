...
class ContinualLearningTrainer:
    def __init__(self, model, hnet, n_contexts, device='cuda'):
        ...
        self.thresholds_contexts = torch.nn.Parameter(torch.full((60,), 2.2), requires_grad=False) # for stimulation data 1.01
    ...
    def deviate_from_mean(self, modulation, context):
        ...
        return min_loss / bar >  1.4 #  for stimulation data 1.01
