...
def split_time_fields(df, start_margin = 10, end_margin = 10,ref_field = None):
...
def train_test_split(df, target_variable = 'x', num_folds = 5):
    ...
    for fold_idx in range(num_folds):
        ...
        y_train['fold'+str(fold_idx)] = y_train_
        X_val['fold'+str(fold_idx)] = X_val_
        y_val['fold'+str(fold_idx)] = y_val_
        X_test['fold'+str(fold_idx)] = X_test_
        y_test['fold'+str(fold_idx)] = y_test_
