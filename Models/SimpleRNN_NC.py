...
# author         :mc, be        --> modified by NC on 24/04/2024
...
class SimpleRNN_NC(nn.Module, MainNetInterface):
    ...
    def __init__(self, n_in=1, rnn_layers=(10,), fc_layers_pre=(),
        ...
        self.dropout = nn.Dropout(p= dropout) # added by NC
    ...
    def forward(self, x, weights=None, distilled_params=None, condition=None,
        ...
        h = torch.sigmoid(h) # added by NC, I want the non-linearity applied to the output
        ...
        if return_hidden:
            ...
            if return_hidden_int:
                ret_hidden_int.pop()
                return h.squeeze(), ret_hidden, ret_hidden_int
            else:
                return h.squeeze(), ret_hidden
        else:
            return h.squeeze() # added by NC
